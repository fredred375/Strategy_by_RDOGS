...
{
	int shopIndex = 1;
	points.emplace_back(2509.34f, 3524.19f, std::to_wstring(shopIndex) + L"Shallot 紅蔥餐館", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2568.f, 4162.4f, std::to_wstring(shopIndex) + L"三角冰冰品專賣店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2540.21f, 3770.33f, std::to_wstring(shopIndex) + L"自由51", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(4902.29f, 1554.5f, std::to_wstring(shopIndex) + L"有意樹桿咖啡", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(5036.92f, 1942.66f, std::to_wstring(shopIndex) + L"老先覺麻辣窯燒鍋", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2380.01f, 2969.f, std::to_wstring(shopIndex) + L"龐德羅莎 台大店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2842.44f, 2277.09f, std::to_wstring(shopIndex) + L"活大餐廳", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2493.52f, 2178.04f, std::to_wstring(shopIndex) + L"摩斯漢堡 小福店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2595.66f, 1980.8f, std::to_wstring(shopIndex) + L"稍飽 燒肉廚房", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2750.51f, 2048.18f, std::to_wstring(shopIndex) + L"女九餐廳", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2499.13f, 2624.16f, std::to_wstring(shopIndex) + L"小木屋鬆餅 台大店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1075.88f, 1630.78f, std::to_wstring(shopIndex) + L"錢都 師大店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1870.54f, 2357.52f, std::to_wstring(shopIndex) + L"七里亭", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1769.02f, 2031.25f, std::to_wstring(shopIndex) + L"小川西堂", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1755.71f, 2234.99f, std::to_wstring(shopIndex) + L"楽坡 公館店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1168.3f, 1718.29f, std::to_wstring(shopIndex) + L"雞二拉麵 師大店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(683.109f, 1114.78f, std::to_wstring(shopIndex) + L"肉多多火鍋 古亭店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(4126.8f, 1443.21f, std::to_wstring(shopIndex) + L"草泥Cafe", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3012.56f, 766.885f, std::to_wstring(shopIndex) + L"瑞安豆漿大王", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2733.74f, 1161.55f, std::to_wstring(shopIndex) + L"馬祖麵館", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1893.7f, 2109.79f, std::to_wstring(shopIndex) + L"好想吃冰 公館店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1905.46f, 2001.53f, std::to_wstring(shopIndex) + L"柒食貳", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1735.87f, 1454.57f, std::to_wstring(shopIndex) + L"糊塗麵", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1990.09f, 2134.15f, std::to_wstring(shopIndex) + L"台一牛奶大王", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1994.28f, 1961.45f, std::to_wstring(shopIndex) + L"璞田PureTime", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2032.46f, 1943.42f, std::to_wstring(shopIndex) + L"鳳城燒臘粵菜", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2105.63f, 1431.18f, std::to_wstring(shopIndex) + L"莫宰羊 大安台大店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1914.25f, 2437.37f, std::to_wstring(shopIndex) + L"比薩幫", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3883.12f, 1360.93f, std::to_wstring(shopIndex) + L"漢堡王 敦南店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3145.61f, 858.561f, std::to_wstring(shopIndex) + L"雷咖哩", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3169.74f, 2832.82f, std::to_wstring(shopIndex) + L"摩斯漢堡 台科大店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2972.79f, 3111.5f, std::to_wstring(shopIndex) + L"台科大第三學餐", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3386.39f, 2303.88f, std::to_wstring(shopIndex) + L"Living One", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3462.38f, 2359.56f, std::to_wstring(shopIndex) + L"星巴克 長興門市", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(4232.01f, 1594.9f, std::to_wstring(shopIndex) + L"黑熊愛跳舞", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(948.992f, 1348.13f, std::to_wstring(shopIndex) + L"秘氏珈琲", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1719.72f, 1194.69f, std::to_wstring(shopIndex) + L"初魚屋台", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1298.73f, 1539.51f, std::to_wstring(shopIndex) + L"小木屋鬆餅 師大店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1432.14f, 1347.37f, std::to_wstring(shopIndex) + L"師園鹽酥雞", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1313.3f, 1215.98f, std::to_wstring(shopIndex) + L"貳樓餐廳 師大店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1393.98f, 1669.68f, std::to_wstring(shopIndex) + L"龍泉深海鮮魚湯", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2621.85f, 417.514f, std::to_wstring(shopIndex) + L"2J CAFE", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1858.32f, 847.971f, std::to_wstring(shopIndex) + L"青田七六", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(4245.77f, 2214.56f, std::to_wstring(shopIndex) + L"富士咖哩", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(4680.56f, 1709.56f, std::to_wstring(shopIndex) + L"佐藤咖哩", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(4492.44f, 1924.97f, std::to_wstring(shopIndex) + L"豬頭天知高飯", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3668.04f, 1265.11f, std::to_wstring(shopIndex) + L"找餐。店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3123.47f, 1519.75f, std::to_wstring(shopIndex) + L"補時", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3444.61f, 1166.83f, std::to_wstring(shopIndex) + L"營養師的光合廚房", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3199.91f, 1640.91f, std::to_wstring(shopIndex) + L"穰穰", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3029.64f, 1088.54f, std::to_wstring(shopIndex) + L"曬貓咖啡", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1468.51f, 1015.58f, std::to_wstring(shopIndex) + L"艾炫咖啡", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3141.32f, 1748.07f, std::to_wstring(shopIndex) + L"蘇草salvia", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2985.13f, 1611.41f, std::to_wstring(shopIndex) + L"揪食堂 韓國餐館", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2815.24f, 1742.25f, std::to_wstring(shopIndex) + L"Open開房間桌遊餐館", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(4635.37f, 1934.3f, std::to_wstring(shopIndex) + L"鴨膳師當歸鴨肉麵線", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(4096.2f, 1282.3f, std::to_wstring(shopIndex) + L"吳一無二法式甜點", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(3727.11f, 1092.02f, std::to_wstring(shopIndex) + L"餘記麵館", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2124.56f, 2801.34f, std::to_wstring(shopIndex) + L"麥當勞 公館店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2013.7f, 2775.56f, std::to_wstring(shopIndex) + L"鴉片粉圓", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2242.89f, 3036.99f, std::to_wstring(shopIndex) + L"墨洋拉麵", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2267.7f, 2953.67f, std::to_wstring(shopIndex) + L"茗香園冰室 公館店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1873.57f, 2610.54f, std::to_wstring(shopIndex) + L"炸手指", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1603.37f, 2460.32f, std::to_wstring(shopIndex) + L"Mr. 雪腐 公館店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(248.934f, 597.765f, std::to_wstring(shopIndex) + L"酮伴咖啡", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1584.69f, 2850.09f, std::to_wstring(shopIndex) + L"水源會館 公館店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(531.113f, 1160.59f, std::to_wstring(shopIndex) + L"夏慕尼鐵板燒 南昌店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1895.68f, 2762.99f, std::to_wstring(shopIndex) + L"馬辣麻辣鴛鴦火鍋", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2112.18f, 2878.95f, std::to_wstring(shopIndex) + L"喫尤平價鐵板燒", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1790.37f, 3329.78f, std::to_wstring(shopIndex) + L"尖蚪", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2240.42f, 3107.65f, std::to_wstring(shopIndex) + L"三媽臭臭鍋", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2211.24f, 3063.88f, std::to_wstring(shopIndex) + L"鍋in百元風味火鍋", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(2044.78f, 2926.24f, std::to_wstring(shopIndex) + L"土司吐司 公館店", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1493.67f, 2404.84f, std::to_wstring(shopIndex) + L"El Sabroso", shopIndex++, textures["locationMark"], &font);
	points.emplace_back(1959.78f, 2633.9f, std::to_wstring(shopIndex) + L"星巴克 公館店", shopIndex++, textures["locationMark"], &font);
